    ...
    <Layout>
      ...
      <div className="flex flex-col text-stone-50 bg-black w-full relative tracking-wider">
        ...
        <div className="prose-invert prose-headings:text-3xl prose-headings:py-4  max-w-none px-8 container prose-headings:font-bold prose-headings:text-stone-100 prose-p:font-extralight prose-ul:font-extralight prose-stone font-inter leading-8 py-12 prose-ul:list-disc prose-ul:pl-12 pb-40 prose-p:text-stone-200 prose-ul:text-stone-200 prose-headings:pt-12">
          ...
          <p>Thank you for visiting the Fadedlines Barbershop website. This Privacy Policy outlines how we collect, use, disclose, and safeguard your information when you visit our website.</p>
          ...
          <ul>
            <li>To provide and manage our website, including processing appointments and inquiries.</li>
          ...
          <ul>
            ...
            <li> Legal Compliance: We may disclose your information when required by law or to protect our rights, property, or safety or that of others.</li>

          </ul>
          <h4>Data Security</h4>
          <p>

            We implement reasonable security measures to protect your personal information from unauthorized access, use, alteration, or destruction. However, please be aware that no method of transmission over the internet or electronic storage is completely secure.
          </p>

          <h4> Your Rights</h4>

          <p> You have certain rights regarding your personal information under applicable data protection laws. These rights may include the right to access, correct, or delete your information. Please contact us using the information provided below to exercise these rights.</p>

          <h4> Links to Third-Party Websites</h4>

          <p>Our website may contain links to third-party websites. We are not responsible for the privacy practices or the content of these websites. We encourage you to read the privacy policies of these linked sites.</p>

          <h4> Children's Privacy</h4>

          <p>Our website is not directed at individuals under the age of 18. We do not knowingly collect personal information from children. If we learn that we have collected personal information from a child without parental consent, we will take steps to delete that information.</p>

          <h4>Changes to This Privacy Policy</h4>

          <p> We may update this Privacy Policy periodically to reflect changes in our practices or for other operational, legal, or regulatory reasons. We encourage you to review this policy periodically for any updates.</p>
