...
import EmblaCarousel from "@/components/CarouselScaled";

import { useEffect,  } from "react";
import Srolled from "@/components/Scrolled";
        ...
        <section className="relative w-full h-[35rem] md:h-[35rem] " >
          ...
          <div className="max-w-screen-lg mx-auto w-full">
            ...
            <div className="px-6 md:px-12 text-stone-50 flex flex-col md:flex-row gap-4 uppercase relative z-30">
              ...
              >
                <a href="  https://book.squareup.com/appointments/wmoppuqdw400fe/location/LY7BZ89WAQ2QS/services">
                  BOOK NOW
                </a>
              </Button>
            </div>
