      ...
      <div className="flex flex-col bg-stone-950 w-full h-full relative">
        ...
        <section className="relative w-full h-[35rem] md:h-[35rem] " >
          ...
          <div className="max-w-screen-lg mx-auto w-full">
            ...
            >
              <h2 className="text-4xl md:text-5xl uppercase font-poppins font-extrabold mb-2 text-[#42FF00] tracking-wider">Hi, I&apos;m wyatt</h2>
